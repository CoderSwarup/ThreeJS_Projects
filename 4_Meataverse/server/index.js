...
/// Choose An The Any Algorithm as You Preffer
...
updateGrid();
// console.log(findPath([0, 1], [2, 8]));

// const generateRandomPosition = () => {
//   return [Math.random() * map.size[0], 0, Math.random() * map.size[1]];
// };
const generateRandomPosition = () => {
  for (let i = 0; i < map.size[0] * map.size[1]; i++) {
...
io.on("connection", (socket) => {
  ...
  characters.push({
    ...
    avatarUrl: "https://models.readyplayer.me/674337c510881d40c4da8035.glb",
  });
  ...
  socket.on("characterAvatarUpdate", (avatarUrl) => {
    ...
    character.avatarUrl = avatarUrl?.split("?")[0] + "?" + new Date().getTime(); // to Load the Updated Model Mot Chached Model

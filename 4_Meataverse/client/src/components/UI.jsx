...
export const UI = () => {
  ...
  return (
    <>
      {avatarMode && (
        <AvatarCreator
          subdomain={import.meta.env.VITE_READYPLAYEME_SUBDOMAIN || "demo"}
          className="fixed top-0 left-0 z-[3] w-screen h-screen"
          AvatarCreatorConfig={config}
      ...
      <div className="fixed inset-4 flex items-end justify-center pointer-events-none z-[2]">

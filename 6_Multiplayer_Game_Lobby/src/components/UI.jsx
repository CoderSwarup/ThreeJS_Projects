...
export const UI = () => {
  ...
  return (
    <>
      <div
        className={`fixed z-[2] top-0 left-0 right-0 h-screen bg-white flex items-center justify-center gap-1 text-5xl pointer-events-none transition-transform duration-500
